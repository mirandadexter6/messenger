        ...
        <div class="panel-heading">
          ...
          <i style="margin-left:200px;" ><?=
            ...
            <div class="btn-group pull-right">          
                ...
                <ul class="dropdown-menu" role="menu" style="margin-right:-120px;">
                  <li><a href="" id="<?=$data->thread_id;?>" >Delete</a></li>
                  <input type="hidden" name="<?=$data->thread_id;?>"  id="id<?=$data->thread_id;?>"  value="<?=$data->thread_id;?>">
                </ul>
              </div>
  ...
  if($getalldata!='')
{
		...
		<script>
            $(function(){
                $( "#<?=$data->thread_id;?>" ).click(function(event)
                {
                    //event.preventDefault();//prevent auto submit data
                    var threadid= $("#id<?=$data->thread_id;?>").val();
                    $.ajax(
                        {
                            type:"post",
